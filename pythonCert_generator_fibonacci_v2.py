...
### CODE ANALYSIS ###
#####################
# We've built the Fib iterator into another class
# (we can say that we've composed it into the Class class).
# It's instantiated along with Class's object.
#
# The object of the class may be used as an iterator when (and only when)
# it positively answers to the __iter__ invocation - this class can do it,
