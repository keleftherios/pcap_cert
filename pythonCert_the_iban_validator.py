...
# to specify account numbers.
# The standard named IBAN (International Bank Account Number) provides a simple
# and fairly reliable method of validating the account numbers against simple typos that can occur
...
# two check digits used to perform the validity checks - fast and simple, but not fully reliable, tests,
...
#
# line 03: ask the user to enter the IBAN (the number can contain spaces,
# as they significantly improve number readability...
...
# line 12: move the four initial characters to the number's end, and convert all letters to upper case
# (step 02 of the algorithm)
# line 13: this is the variable used to complete the number, created by replacing the letters with digits
# (according to the algorithm's step 03)
