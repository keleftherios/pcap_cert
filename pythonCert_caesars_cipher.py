...
# We're going to show you four simple programs in order to present some aspects of string processing in Python.
# They are purposefully simple, but the lab problems will be significantly more complicated.
# 
# The first problem we want to show you is called the Caesar cipher - more details here:
...
# line 06: ...ignore it;
# line 07: convert the letter to upper-case (it's preferable to do it blindly,
# rather than check whether it's needed or not)
...
# The reverse transformation should now be clear to you - let's just present you with the code as-is,
