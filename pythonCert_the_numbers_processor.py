...
#
# Note:
# the routine input() function, combined together with the int() or float() functions,
...
# line 06: as the string-float conversion may raise an exception,
# it's best to continue with the protection of the try-except block;
